...
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e}{}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e}\index{enhanced-\/resolve@{enhanced-\/resolve}}
\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1189}%
\Hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1189}%
...
Offers an async require.\+resolve function. It\textquotesingle{}s highly configurable.\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1190}{}\doxysection{\texorpdfstring{Features}{Features}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1190}

\begin{DoxyItemize}
\item plugin system
\item provide a custom filesystem
\item sync and async node.\+js filesystems included
\end{DoxyItemize}\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1191}{}\doxysection{\texorpdfstring{Getting Started}{Getting Started}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1191}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1192}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1192}
...
\end{DoxyCode}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1193}{}\doxysubsection{\texorpdfstring{Resolve}{Resolve}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1193}
...
\end{DoxyCode}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1194}{}\doxysubsection{\texorpdfstring{Creating a Resolver}{Creating a Resolver}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1194}
...
\DoxyCodeLine{myResolver.resolve(}
\DoxyCodeLine{\ \ \ \ context,}
\DoxyCodeLine{\ \ \ \ lookupStartPath,}
\DoxyCodeLine{\ \ \ \ request,}
\DoxyCodeLine{\ \ \ \ resolveContext,}
\DoxyCodeLine{\ \ \ \ (err\ /*\ Error\ */,\ filepath\ /*\ string\ */)\ =>\ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ //\ Do\ something\ with\ the\ path}
\DoxyCodeLine{\ \ \ \ \},}
\DoxyCodeLine{);}

\end{DoxyCode}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1195}{}\doxysubsubsection{\texorpdfstring{Resolver Options}{Resolver Options}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1195}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1196}{}\doxysection{\texorpdfstring{Plugins}{Plugins}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1196}
...
A plugin should be a {\ttfamily class} (or its ES5 equivalent) with an {\ttfamily apply} method. The {\ttfamily apply} method will receive a {\ttfamily resolver} instance, that can be used to hook in to the event system.\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1197}{}\doxysubsection{\texorpdfstring{Plugin Boilerplate}{Plugin Boilerplate}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1197}
...
Plugins are executed in a pipeline, and register which event they should be executed before/after. In the example above, {\ttfamily source} is the name of the event that starts the pipeline, and {\ttfamily target} is what event this plugin should fire, which is what continues the execution of the pipeline. For an example of how these different plugin events create a chain, see {\ttfamily lib/\+Resolver\+Factory.\+js}, in the {\ttfamily //// pipeline ////} section.\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1198}{}\doxysection{\texorpdfstring{Escaping}{Escaping}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1198}
It\textquotesingle{}s allowed to escape {\ttfamily \#} as {\ttfamily \textbackslash{}0\#} to avoid parsing it as fragment.

enhanced-\/resolve will try to resolve requests containing {\ttfamily \#} as path and as fragment, so it will automatically figure out if {\ttfamily ./some\#thing} means {\ttfamily .../some.js\#thing} or {\ttfamily .../some\#thing.\+js}. When a {\ttfamily \#} is resolved as path it will be escaped in the result. Here\+: {\ttfamily .../some\textbackslash{}0\#thing.\+js}.\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1199}{}\doxysection{\texorpdfstring{Tests}{Tests}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1199}

\begin{DoxyCode}{0}
\DoxyCodeLine{yarn\ test}

\end{DoxyCode}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1200}{}\doxysection{\texorpdfstring{Passing options from webpack}{Passing options from webpack}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1200}
...
\end{DoxyCode}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1201}{}\doxysection{\texorpdfstring{License}{License}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2enhanced-resolve_2_r_e_a_d_m_e_autotoc_md1201}
