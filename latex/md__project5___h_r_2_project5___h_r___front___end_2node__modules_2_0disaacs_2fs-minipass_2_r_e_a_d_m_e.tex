\chapter{fs-\/minipass}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2_0disaacs_2fs-minipass_2_r_e_a_d_m_e}{}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2_0disaacs_2fs-minipass_2_r_e_a_d_m_e}\index{fs-\/minipass@{fs-\/minipass}}
\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2_0disaacs_2fs-minipass_2_r_e_a_d_m_e_autotoc_md291}%
\Hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2_0disaacs_2fs-minipass_2_r_e_a_d_m_e_autotoc_md291}%
...
The async versions work much like their node builtin counterparts, with the exception of introducing significantly less Stream machinery overhead.\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2_0disaacs_2fs-minipass_2_r_e_a_d_m_e_autotoc_md292}{}\doxysection{\texorpdfstring{USAGE}{USAGE}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2_0disaacs_2fs-minipass_2_r_e_a_d_m_e_autotoc_md292}
It\textquotesingle{}s just streams, you pipe them or read() them or write() to them.


\begin{DoxyCode}{0}
\DoxyCodeLine{import\ \{\ ReadStream,\ WriteStream\ \}\ from\ 'fs-\/minipass'}
\DoxyCodeLine{//\ or:\ const\ \{\ ReadStream,\ WriteStream\ \}\ =\ require('fs-\/minipass')}
\DoxyCodeLine{const\ readStream\ =\ new\ ReadStream('file.txt')}
\DoxyCodeLine{const\ writeStream\ =\ new\ WriteStream('output.txt')}
\DoxyCodeLine{writeStream.write('some\ file\ header\ or\ whatever\(\backslash\)n')}
\DoxyCodeLine{readStream.pipe(writeStream)}

\end{DoxyCode}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2_0disaacs_2fs-minipass_2_r_e_a_d_m_e_autotoc_md293}{}\doxysection{\texorpdfstring{Read\+Stream(path, options)}{Read\+Stream(path, options)}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2_0disaacs_2fs-minipass_2_r_e_a_d_m_e_autotoc_md293}
...
\end{DoxyItemize}\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2_0disaacs_2fs-minipass_2_r_e_a_d_m_e_autotoc_md294}{}\doxysection{\texorpdfstring{Write\+Stream(path, options)}{Write\+Stream(path, options)}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2_0disaacs_2fs-minipass_2_r_e_a_d_m_e_autotoc_md294}
Path string is required, but somewhat irrelevant if an open file descriptor is passed in as an option.
