\chapter{Tapable}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e}{}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e}\index{Tapable@{Tapable}}
\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2940}%
\Hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2940}%
...
\end{DoxyCode}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2941}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2941}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ install\ -\/-\/save\ tapable}

\end{DoxyCode}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2942}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2942}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{myCar.hooks.accelerate.tap("{}LoggerPlugin"{},\ (newSpeed)\ =>}
\DoxyCodeLine{\ \ \ \ console.log(`Accelerating\ to\ \$\{newSpeed\}`)}
\DoxyCodeLine{);}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{myCar.hooks.calculateRoutes.tapPromise(}
\DoxyCodeLine{\ \ \ \ "{}GoogleMapsPlugin"{},}
\DoxyCodeLine{\ \ \ \ (source,\ target,\ routesList)\ =>}
\DoxyCodeLine{\ \ \ \ \ \ \ \ //\ return\ a\ promise}
\DoxyCodeLine{\ \ \ \ \ \ \ \ google.maps.findRoute(source,\ target).then((route)\ =>\ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ routesList.add(route);}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \})}
\DoxyCodeLine{);}
\DoxyCodeLine{myCar.hooks.calculateRoutes.tapAsync(}
\DoxyCodeLine{\ \ \ \ "{}BingMapsPlugin"{},}
\DoxyCodeLine{\ \ \ \ (source,\ target,\ routesList,\ callback)\ =>\ \{}
...
\DoxyCodeLine{myCar.hooks.calculateRoutes.tap(}
\DoxyCodeLine{\ \ \ \ "{}CachedRoutesPlugin"{},}
\DoxyCodeLine{\ \ \ \ (source,\ target,\ routesList)\ =>\ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ const\ cachedRoute\ =\ cache.get(source,\ target);}
\DoxyCodeLine{\ \ \ \ \ \ \ \ if\ (cachedRoute)\ routesList.add(cachedRoute);}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{);}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ return\ this.hooks.calculateRoutes}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ .promise(source,\ target,\ routesList)}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ .then((res)\ =>}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ //\ res\ is\ undefined\ for\ AsyncParallelHook}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ routesList.getRoutes()}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ );}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
...
This ensures fastest possible execution.\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2943}{}\doxysection{\texorpdfstring{Hook types}{Hook types}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2943}
...
The hook type is reflected in its class name. E.\+g., {\ttfamily Async\+Series\+Waterfall\+Hook} allows asynchronous functions and runs them in series, passing each function’s return value into the next function.\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2944}{}\doxysection{\texorpdfstring{Interception}{Interception}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2944}
...
{\bfseries{register}}\+: {\ttfamily (tap\+: Tap) =\texorpdfstring{$>$}{>} Tap \texorpdfstring{$\vert$}{|} undefined} Adding {\ttfamily register} to your interceptor will trigger for each added {\ttfamily Tap} and allows to modify it.\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2945}{}\doxysection{\texorpdfstring{Context}{Context}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2945}
...
\end{DoxyCode}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2946}{}\doxysection{\texorpdfstring{Hook\+Map}{Hook\+Map}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2946}
...
\end{DoxyCode}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2947}{}\doxysection{\texorpdfstring{Hook/\+Hook\+Map interface}{Hook/\+Hook\+Map interface}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2947}
Public\+:
...
\DoxyCodeLine{\ \ \ \ tapAsync:\ (}
\DoxyCodeLine{\ \ \ \ \ \ \ \ name:\ string\ |\ Tap,}
\DoxyCodeLine{\ \ \ \ \ \ \ \ fn:\ (}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ context?,}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ ...args,}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ callback:\ (err:\ Error\ |\ null,\ result:\ Result)\ =>\ void}
\DoxyCodeLine{\ \ \ \ \ \ \ \ )\ =>\ void}
\DoxyCodeLine{\ \ \ \ )\ =>\ void;}
\DoxyCodeLine{\ \ \ \ tapPromise:\ (}
\DoxyCodeLine{\ \ \ \ \ \ \ \ name:\ string\ |\ Tap,}
\DoxyCodeLine{\ \ \ \ \ \ \ \ fn:\ (context?,\ ...args)\ =>\ Promise<Result>}
\DoxyCodeLine{\ \ \ \ )\ =>\ void;}
...
\end{DoxyCode}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2948}{}\doxysection{\texorpdfstring{Multi\+Hook}{Multi\+Hook}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2tapable_2_r_e_a_d_m_e_autotoc_md2948}
