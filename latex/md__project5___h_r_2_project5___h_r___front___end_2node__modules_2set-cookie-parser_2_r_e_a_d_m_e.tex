\chapter{set-\/cookie-\/parser}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e}{}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e}\index{set-\/cookie-\/parser@{set-\/cookie-\/parser}}
\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2853}%
\Hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2853}%
...
(The output format is loosely based on the input format of \href{https://www.npmjs.com/package/cookie}{\texttt{ https\+://www.\+npmjs.\+com/package/cookie}})\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2856}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2856}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ -\/-\/save\ set-\/cookie-\/parser}

\end{DoxyCode}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2857}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2857}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2858}{}\doxysubsection{\texorpdfstring{Get array of cookie objects}{Get array of cookie objects}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2858}
...
\end{DoxyCode}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2859}{}\doxysubsection{\texorpdfstring{Get map of cookie objects}{Get map of cookie objects}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2859}
...
\end{DoxyCode}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2860}{}\doxysubsection{\texorpdfstring{Creating a new, modified set-\/cookie header}{Creating a new, modified set-\/cookie header}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2860}
...
See a real-\/world example of this in \href{https://github.com/nfriedly/node-unblocker/blob/08a89ec27274b46dcd80d0a324a59406f2bdad3d/lib/cookies.js\#L67-L85}{\texttt{ unblocker}}\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2861}{}\doxysection{\texorpdfstring{Usage in React Native (and with some other fetch implementations)}{Usage in React Native (and with some other fetch implementations)}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2861}
...
Note that the {\ttfamily fetch()} spec now includes a {\ttfamily get\+Set\+Cookie()} method that provides un-\/combined {\ttfamily Set-\/\+Cookie} headers. This library will automatically use that method if it is present.\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2862}{}\doxysection{\texorpdfstring{API}{API}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2862}
\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2863}{}\doxysubsection{\texorpdfstring{parse(input, \mbox{[}options\mbox{]})}{parse(input, \mbox{[}options\mbox{]})}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2863}
Parses cookies from a string, array of strings, or a http response object. Always returns an array, regardless of input format. (Unless the {\ttfamily map} option is set, in which case it always returns an object.)\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2864}{}\doxysubsection{\texorpdfstring{parse\+String(individual\+Set\+Cookie\+Header, \mbox{[}options\mbox{]})}{parse\+String(individual\+Set\+Cookie\+Header, \mbox{[}options\mbox{]})}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2864}
Parses a single set-\/cookie header value string. Options default is {\ttfamily \{decode\+Values\+: true\}}. Used under-\/the-\/hood by {\ttfamily parse()}. Returns an object.\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2865}{}\doxysubsection{\texorpdfstring{split\+Cookies\+String(combined\+Set\+Cookie\+Header)}{split\+Cookies\+String(combined\+Set\+Cookie\+Header)}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2865}
It\textquotesingle{}s uncommon, but the HTTP spec does allow for multiple of the same header to have their values combined (comma-\/separated) into a single header. This method splits apart a combined header without choking on commas that appear within a cookie\textquotesingle{}s value (or expiration date). Returns an array of strings that may be passed to {\ttfamily parse()}.\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2866}{}\doxysection{\texorpdfstring{References}{References}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2866}
...
\end{DoxyItemize}\hypertarget{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2867}{}\doxysection{\texorpdfstring{License}{License}}\label{md__project5___h_r_2_project5___h_r___front___end_2node__modules_2set-cookie-parser_2_r_e_a_d_m_e_autotoc_md2867}
