const HomePage = () => {
  return (
    <div className='p-5'>
      <div className='h-screen flex flex-col justify-center items-center space-y-[30px]'>
        <div className='w-fit'>
        ...
        <div className='w-fit'>
          <div className="label">Author: Tyler Dao, Hui-Ying Huang, Harsh Shivkumar Chauhan</div>
        </div>
      </div>
    </div>
  );
